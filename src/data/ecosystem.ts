...
export const SWAL_APPS: SwalApp[] = [
  {
    ...
    repoUrl: 'https://github.com/iberi22/manteniapp',
  ...
  },
  {
    ...
    repoUrl: 'https://github.com/world-exams/world-exams.github.io',
  },
  {
    id: 'shelf',
    name: 'Shelf',
    ...
    repoUrl: 'https://github.com/iberi22/shelf',
  },
  {
    id: 'orionhealth',
    name: 'OrionHealth',
  ...
  },
  {
    ...
    status: 'active',
    repoUrl: 'https://github.com/iberi22/pocket_cerebro',
  },
  {
    id: 'swal-vault',
    name: 'SWAL Vault',
    ...
    status: 'active',
    repoUrl: 'https://github.com/iberi22/swal-vault',
  },
  {
    id: 'tiktboost',
    name: 'TikTokBoost',
    ...
    repoUrl: 'https://github.com/iberi22/tiktboost',
  },
  {
    id: 'maloca',
    name: 'Maloca',
    ...
    status: 'active',
    repoUrl: 'https://github.com/iberi22/maloca',
  },
  {
    id: 'gos',
  ...
  },
  {
    ...
    status: 'active',
    repoUrl: 'https://github.com/iberi22/veedur-IA.co',
  },
  {
    id: 'nido',
    name: 'Nido',
    ...
    status: 'active',
    repoUrl: 'https://github.com/iberi22/nido',
  },
  {
    id: 'software-factory',
    ...
    status: 'active',
    repoUrl: 'https://github.com/iberi22/software-factory',
  }
];
...
export const TRIPRO_CASE_STUDY = {
  ...
  metrics: [
    { label: 'Uptime en Terreno', value: '100%', detail: 'Operación continua en minas sin internet' },
    { label: 'Coste por Usuario', value: 'bash / mes', detail: 'Sin licencias SaaS recurrentes' },
    { label: 'Privacidad de Datos', value: '100% Local', detail: 'Datos operativos soberanos en Chile' },
    { label: 'Firmas Digitales', value: 'Instantáneas', detail: 'Validación biométrica en faena' }
  ]
};
